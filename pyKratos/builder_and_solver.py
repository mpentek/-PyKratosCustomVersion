...
class BuilderAndSolver:
    use_sparse_matrices = True  ## dünnbesetzte Matrix nutzen!
    ...
    ## Aufgerufen von strategy.Initialize
            ...
            for elem in self.model_part.ElementIterators():
                ...
                for i in range(0, len(equation_id)):
                    ...
                    for j in range(0, len(equation_id)):
                        eq_j = equation_id[j]
                        A[eq_i, eq_j] = 1.0  # set it to 1 to ensure it is converted well
    ...
    ## Aufgerufen von builder_and_solver.buildAndSolve
