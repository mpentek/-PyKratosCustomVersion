...
class ModelPart:
    ...
    def AddNodalConditions(self, condition_name, dict_of_conditions):
    ...
    def AddElementConditions(self, condition_name, dict_of_conditions):
        cond = __import__(condition_name)
        ...
        for el_id, tmp in list(dict_of_conditions.items()):
            ...
            # create the condition
            condition = cond.Create(el_id, prop, node_list)
    ...
    def __str__(self):
        return "ModelPart:\n    Number of Nodes: {0}\n    Number of Elements: {1}\n    Number of Conditions: {2}".format(len(self.Nodes), len(self.Elements), len(self.Conditions))
